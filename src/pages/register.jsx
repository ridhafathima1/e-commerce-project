...
function Register(){
    ...
    <div className="flex min-h-screen items-center justify-center bg-pink-50 px-4">
        ...
        <h1 className="text-center text-4xl font-bold text-pink-600">GLORIA</h1>
        ...
        <form onSubmit={handleregister}>
            ...
            <div className="mb-6">
                <label className="mb-2block font-medium text-gray-700">confirm password</label>
                <input type="password" placeholder="confirm your password" value={confirm} onChange={(e)=>setconfirm(e.target.value)} required className="w-full rounded-lg border border-gray-300 px-4 py-3 outline-none focus:border-pink-500"/>
            </div>
